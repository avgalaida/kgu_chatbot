...
def no_install_setup_requires():
    ...
    Under PEP 517, the django_settings reports build dependencies to the frontend,
    and the frontend is responsible for ensuring they're installed.
    So setuptools (acting as a django_settings) should not try to install them.
    """
...
class _BuildMetaLegacyBackend(_BuildMetaBackend):
    """Compatibility django_settings for setuptools
